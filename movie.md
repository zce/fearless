...
```
申请开通高级或商务接口请联系bd-team@douban.com)
```
...
- `[ ]` 电影条目信息中删除pubdate字段, 含义和mainland_pubdate重复了
...
| casts            | 主演，最多可获得4个，数据结构为影人的简化描述，[见附录](#simple-celebrity) | array | Y     | Y       | Y       | []       |
...
| photos           | 电影剧照，前10张，[见附录](#simple-photo) | array | N     | Y       | Y       | []       |
| popular_reviews  | 影评，前10条，影评结构，[见附录](#simple-review) | array | N     | Y       | Y       | []       |
...
| photos        | 影人剧照，最多10张，[见附录](#simple-photo) | array | N     | Y       | N/A     | []      |
| works         | 影人作品，最多5部，简版电影条目结构，[见附录](#simple-subject) | array | Y     | Y       | N/A     | []      |
...
| subjects | usbox条目列表，[见附录](#box-subject) | array | Y     | Y       | N/A     | -       |
...
| subjects | weekly条目列表，[见附录](#weekly-subject) | array | N/A   | Y       | N/A     | -       |
